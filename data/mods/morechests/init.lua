...
function create_chest(chest_info)
    ...
    local front_locked = chest_info.textures.front_locked

    minetest.register_node(name, {
        tile_images = {sides, sides, sides, sides, sides, front},
    ...
    minetest.register_node(name.."_locked", {
        tile_images = {sides, sides, sides, sides, sides, front_locked},
        inventory_image = minetest.inventorycube(sides, front_locked, sides),
        paramtype = "facedir_simple",
        metadata_name = "generic",
        material = chest_info.material.digprop
    })
    ...
    minetest.register_on_placenode(function(pos, newnode, placer)
        ...
        if newnode.name == name.."_locked" then
            meta:set_enforce_owner(true)
            meta:set_infotext(chest_info.info.." (locked)")
        end
    end)
    ...
    minetest.register_craft({
        output = 'node "'..name..'_locked" 1',
        recipe = {
            {chest_info.material.stack, chest_info.material.stack, chest_info.material.stack},
            {chest_info.material.stack, 'node "default:chest_locked"', chest_info.material.stack},
            {chest_info.material.stack, chest_info.material.stack, chest_info.material.stack},
        }
    })
...
stone_chest = {
    ...
    textures = {
        ...
        front_locked = "morechests_stone_chest_locked_front.png",
...
iron_chest = {
    ...
    textures = {
        ...
        front_locked = "morechests_iron_chest_locked_front.png",
...
mese_chest = {
    ...
    textures = {
        ...
        front_locked = "morechests_mese_chest_locked_front.png",
